...
remove_first_item = cargo_hold.pop(0)
print(remove_first_item)

# append and insert require arguments inside the (). 
# Add the items 1138 and ‘20 meters’ to the the list - the number at the start and the string at the end. Print the updated list to confirm the changes.
